...
MATERIALS_LIST = [
	...
	{"name" : "Aluminum",     "group" : "Mechanic structures"},
	{"name" : "Honeycomb",    "group" : "Mechanic structures"},
	{"name" : "CarbonFibre",  "group" : "Mechanic structures"},
    ...
    {"name" : "Iron",         "group" : "Other"},
    {"name" : "Kapton",       "group" : "Other"},
    {"name" : "PORON",        "group" : "Selfdefined"},
    {"name" : "EVA",          "group" : "Selfdefined"},
    {"name" : "MYLAR",        "group" : "Selfdefined"},
    {"name" : "FTNA",         "group" : "Selfdefined"},
    {"name" : "Silica",       "group" : "Selfdefined"},
    {"name" : "CsI",          "group" : "Selfdefined"},
    {"name" : "Chip",         "group" : "Selfdefined"},
    {"name" : "Gla2Cs1",      "group" : "Selfdefined"},
    {"name" : "Teflon",       "group" : "Selfdefined"},
    {"name" : "Nylon",        "group" : "Selfdefined"},
    {"name" : "SUS304",       "group" : "Selfdefined"},
    {"name" : "Air",          "group" : "Selfdefined"},
    {"name" : "PMMA",         "group" : "Selfdefined"},
]
...
MATERIALS = '''
    <materials>
        ...
        <element name="iodine"     formula="I"   Z="53">   <atom value="126.9"/>   </element>
        <element name="cesium"     formula="Cs"  Z="55">   <atom value="132.9054"/>   </element>
	...
	<!-- materials -->
     ...
     <!--  below are user-defined materials      -->
     
        <!--          -->
        <!--  PORON   -->
        <!--  Polyurethane        -->
        <material name="PORON" formula="C10H16O">
           <D value="3" unit="g/cm3"/>
        ...
        <material name="EVA" formula="(C2H4)0.8(C4H6O2)0.2">
           <D value="2.5" unit="g/cm3"/>
        ...
        <!--          -->
        <!--  MYLAR   -->
        <!--  a kind of Polyester film        -->
        <material name="MYLAR" formula="C9H8O4">
        ...
        <!--          -->
        <!--  FTNA    -->
        <!--  Ferro-tungsten-nickel alloy        -->
        <material name="FTNA" >
           <D value="18" unit="g/cm3"/>
           <fraction n="0.95" ref="tungsten"/>
	       <fraction n="0.03" ref="nickel"/>
           <fraction n="0.02" ref="iron"/>
        </material>
	
        <!--          -->
        <!--  Silica  -->
        <!--  silicone rubber and thermal silicon        -->
        <material name="Silica" formula="(SiO2)1(H2O)1" >
           <D value="1.2" unit="g/cm3"/>
           <composite n="1" ref="silicon"/>
        ...
        <material name="CsI" >
	       ...
	       <composite n="1" ref="iodine"/>
        </material>
	  
	    <!--          -->
        <!--  Gla2Cs1     -->
        <!--  mixture of Glass and CsI, mass ratio is 1        -->
        <material name="Gla2Cs1" >
           <D value="6.71" unit="g/cm3"/>
           <fraction n="0.5" ref="CsI"/>
	       <fraction n="0.5" ref="Glass"/>
        </material>
		
		<!--          -->
        <!--  Teflon     -->
        <!--  material of black tape        -->
        <material name="Teflon" >
           <D value="2" unit="g/cm3"/>
           <composite n="2" ref="carbon"/>
		...
		<!--          -->
        <!--  Nylon     -->
        <!--  Polyamide [NH(CH2)5CO], material of connevtor        -->
        <material name="Nylon" >
		...
		<!--          -->
        <!--  SUS304     -->
        <!--  a kind of stainless steel, mixed with chromium and nickel        -->
        <material name="SUS304" >
           <D value="7.93" unit="g/cm3"/>
		...
		<!--  another name of silicon, used to mark silicon chip        -->
	    <material name="Chip" >
           <D value="2.333" unit="g/cm3"/>
           <fraction n="1." ref="silicon"/>
        </material>
...
STRUCTURE1 = '''
    <structure>
        <volume name="%s">
            <materialref ref="%s"/>
            <solidref ref="%s"/>
	        <auxiliary auxtype="%s" auxvalue="%s"/>
            <auxiliary auxtype="%s" auxvalue="%s"/> 
        </volume>
    </structure>
'''
...
def stl_to_gdml(fname):
	...
	# structure
	structure = STRUCTURE%(outname, material, outsolidname,"") if material!="Chip" else STRUCTURE1%(outname,material,outsolidname,"SensDet","ChipSD","Color","Green")
