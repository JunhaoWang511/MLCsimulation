...
public:
    ...
    inline void SetKineticEnergy(G4double ke) { fKEnergy = ke; }
    inline G4double GetKineticEnrgy() { return fKEnergy; }
    ...
    G4ThreeVector GetDirection(void) { return fDirection; }

    void SetPrePhysVolumeName(const G4String &name) { fPrePhysVolumeName = name; }
    G4String &GetPrePhysVolumeName(void) { return fPrePhysVolumeName; }

    void SetPostPhysVolumeName(const G4String &name) { fPostPhysVolumeName = name; }
    G4String &GetPostPhysVolumeName(void) { return fPostPhysVolumeName; }
...
private:
    ...
    G4bool fPrimary;
    G4String fName;
    G4String fPrePhysVolumeName;
    G4String fPostPhysVolumeName;
    G4int fTrackid;
    G4int fParentid;
    G4int fStepNumber;
